...
export default function Cycle3Page() {
  ...
  return (
    <main className="max-w-4xl mx-auto p-6">
      <h1 className="text-2xl sm:text-3xl font-bold mb-6 text-blue-700 dark:text-blue-300">Liste de lecture du Cycle 3</h1>
